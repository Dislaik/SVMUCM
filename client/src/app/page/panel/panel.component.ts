        ...
        series: [
          {
            ...
            data: [
              ...
              { value: this.projectsByStatus['approved'], name: 'Aprobado', itemStyle: { color: 'rgba(145, 204, 117, 1)' } },
              { value: this.projectsByStatus['rejected'], name: 'Rechazado', itemStyle: { color: 'rgba(238, 102, 102, 1)' } },
              { value: this.projectsByStatus['underreview'], name: 'En revisión', itemStyle: { color: 'rgba(250, 200, 88, 1)' } }
            ],
            emphasis: {
              itemStyle: {
                shadowBlur: 10,
